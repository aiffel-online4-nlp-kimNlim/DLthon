...
|:---:|---|---|:---:|
|Origin Data|0.8560|0.8557|0.8579|
...
|:---:|---|---|:---:|
|Origin Data|0.8560|0.8557|0.8579|
|Origin Data + RS(100%) + RD(100%)|0.9530|0.9530|0.9534|
|Origin Data + RS(100%) + BT-EN(50%)|0.8962|0.8964|0.8958|
|Origin Data + RS(100%) + BT-JA(50%)|0.8721|0.8724|0.8732|
|Origin Data + RD(100%) + BT-EN(50%)|0.8842|0.8841|0.8848|
|Origin Data + RD(100%) + BT-JA(50%)|0.8563|0.8567|0.8572|
|Origin Data + BT-EN(50%) + BT-JA(50%)|0.8591|0.8591|0.8588|
|Origin Data + RS(100%) + RD(100%) + BT-EN(50%)|0.9331|0.9331|0.9329|
|Origin Data + RS(100%) + RD(100%) + BT-JA(50%)|0.9168|0.9167|0.9164|
|Origin Data + RD(100%) + BT-EN(50%) + BT-JA(50%)|0.8998|0.8998|0.9001|
|Origin Data + RS(100%) + RD(100%) + BT-EN(50%) + BT-JA(50%)|0.9323|0.9323|0.9322|

* `EDA`방법으로 증강한 데이터만 추가하는 것이 정확도가 가장 높았음
* 이후 테스트는 Origin Data + RS(100%) + RD(100%) 로 진행
